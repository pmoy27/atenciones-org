                ...
                <form action="{{route('atenciones.store')}}" method="post" class="  max-w-2xl m-auto ">
                    ...
                    <div class="grid gap-4 mb-4 grid-cols-1">
                        ...
                        <div class="col-span-2 sm:col-span-1">
                            <label for="" class="block text-[12px] font-semibold text-gray-500 mb-1 uppercase">Tipo de Atención <span class="text-red-700 text-sm">*</span></label>
                        ...
                        <div class="col-span-2 sm:col-span-1">
                            <label for="" class="block text-[12px] font-semibold text-gray-500 mb-1 uppercase">Fecha de la Atención <span class="text-red-700 text-sm">*</span></label>
                        ...
                        <div class="col-span-4 sm:col-span-1">
                            <label for="" class="block text-[12px] font-semibold text-gray-500 mb-1 uppercase"> Detalle de la atención <span class="text-red-700 text-sm">*</span></label>
