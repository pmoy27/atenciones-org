...
<aside id="default-sidebar" class="fixed top-0 left-0 z-40 lg:w-64 w-[80%] h-screen transition-transform -translate-x-full lg:translate-x-0" aria-label="Sidebar">
    <div class="h-full px-3 py-4 overflow-y-auto bg-gray-800">
        ...
        <ul class="space-y-2 text-sm">
            ...
            <li>
                <a href="{{ route('personas.index') }}" class="flex items-center p-2 rounded-lg text-white  hover:bg-gray-700 group @if(request()->routeIs('personas.index')) bg-gray-700 @elseif(request()->routeIs('personas.create')) bg-gray-700 @elseif(request()->routeIs('personas.detalle')) bg-gray-700 @endif">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="text-white" width="16" height="16" color="#000000" fill="none">
                        <path d="M2.5 12C2.5 7.52166 2.5 5.28249 3.89124 3.89124C5.28249 2.5 7.52166 2.5 12 2.5C16.4783 2.5 18.7175 2.5 20.1088 3.89124C21.5 5.28249 21.5 7.52166 21.5 12C21.5 16.4783 21.5 18.7175 20.1088 20.1088C18.7175 21.5 16.4783 21.5 12 21.5C7.52166 21.5 5.28249 21.5 3.89124 20.1088C2.5 18.7175 2.5 16.4783 2.5 12Z" stroke="currentColor" stroke-width="1.5" />
        ...
        <ul class=" mt-5 space-y-2 text-sm">
            <li>
                <a href="{{ route('organizaciones.index') }}" class="flex items-center p-2 rounded-lg text-white  hover:bg-gray-700 group  @if(request()->routeIs('organizaciones.index')) bg-gray-700 @endif">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="text-white" width="16" height="16" color="#000000" fill="none">
                    ...
                    <span class="ms-3">Lista de organzaciones</span>
                </a>
            </li>
            <li>
                <a href="{{ route('gestion.index') }}" class="flex items-center p-2 rounded-lg text-white  hover:bg-gray-700 group @if(request()->routeIs('gestion.index')) bg-gray-700 @endif">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="text-white" width="16" height="16" color="#000000" fill="none">
